...
module.exports = function (opts) {
  ...
  var DOCTOR_URL = 'doctor1.dwebx.net'
  ...
  var tasks = [
    ...
    {
      title: 'Checking DWebX Native Module Installation',
      task: nativeModuleTask
    },
    {
      title: 'Pinging the DWebX Doctor',
      task: dnsLookupTask
    },
    {
      title: 'Checking DWebX Public Connections via TCP',
      task: function (state, bus, done) {
    ...
    {
      title: 'Checking DWebX Public Connections via UTP',
      task: function (state, bus, done) {
